...
from sqlalchemy import DateTime, ForeignKey, Integer, Numeric, String, func, JSON
...
class Job(Base):
    ...
    # E-Commerce Catalog & Vision Intelligence
    catalog_data: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    detected_gender: Mapped[str | None] = mapped_column(String(20), nullable=True)
    detected_garment_type: Mapped[str | None] = mapped_column(String(50), nullable=True)
